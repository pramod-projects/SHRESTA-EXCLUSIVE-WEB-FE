...
export default async function AdminIndexPage() {
  await requireAdminModuleAccess("overview");
    ...
    <div className="space-y-6">
      <header className="flex flex-col gap-4 border-b border-[var(--shresta-logo-border)] pb-5 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-4xl text-sm leading-6 text-[var(--shresta-logo-muted)]">
            Manage category taxonomy, canonical media, SKU bindings, and governed approvals from one operations console.
          </p>
        </div>
      ...
      <section className="grid gap-4 xl:grid-cols-3">
        <ActionPanel
          ...
          summary="Upload canonical images and videos directly to R2, edit every customer-visible product field, and manage governed asset metadata in one place."
        />
        <ActionPanel
          cta="Open Categories"
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full min-w-[900px] text-left text-sm">
            ...
            <tbody>
              ...
              />
              <ContractRow
                current={`${assets.total} canonical media objects`}
                fields="object key, dimensions, content type, product binding, tags, alt text, SEO"
      ...
      <section className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="admin-panel rounded-lg p-4">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            ...
            <Metric label="Product Linked" value={skuLinkedAssets.toString()} note="Canonical media with product binding" />
