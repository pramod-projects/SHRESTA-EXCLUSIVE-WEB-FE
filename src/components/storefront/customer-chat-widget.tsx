...
export function CustomerChatWidget() {
  ...
  const sendDisabledReason = isTyping
    ? "Assistant is responding. Please wait before sending another message."
    : !inputValue.trim()
        ...
        {isOpen ? (
          ...
          >
            ...
            <div className="border-t border-[var(--shresta-logo-border)] bg-[var(--shresta-logo-surface)] p-4 backdrop-blur-sm">
              ...
              {sendDisabledReason ? (
                <p className="mt-2 text-center text-[11px] font-medium text-[var(--shresta-logo-muted)]">{sendDisabledReason}</p>
              ) : null}
